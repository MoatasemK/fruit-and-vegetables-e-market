...
import { getFormInputFields } from './add-annonce.preset';

export function AddAnnonceScreen() {
  ...
  const handleOnSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const result = zodValidator(
      { ...formBody, price: +formBody.price },
      annoncesDTOs.createAnnoncePayloadSchema,
    );
    ...
    try {
      ...
      await annoncesApi.create(result.data);
        ...
        <IonCardContent>
          ...
          >
            ...
            <IonButton
              ...
              type="submit"
            >
              {submitting ? <IonSpinner /> : <>Create Annonce</>}
            </IonButton>
          </form>
        </IonCardContent>
      </IonCard>
